          ...
          method="post" autocomplete="on">
            ...
            <div class="w3-row">
              ...
              <div class="w3-threequarter w3-container">
                ...
                title="Initial capital, spaces, and hypens allowed"
                pattern="^[A-Z][A-Za-z -]*$">
                <span class="w3-text-red">*</span>
              </div>
            </div>
            ...
            <div class="w3-row">
              ...
              <div class="w3-threequarter w3-container">
                ...
                value=""
                title="x@y.z, with . or - allowed in x and/or y, and z have only
                2 or 3 letters"
		...
		title="xxx-yyy-zzzz, (xxx)yyy-zzzz or just yyy-zzzz"
            ...
            <div class="w3-row w3-section">
              ...
              <div class="w3-threequarter w3-container w3-wide">
                ...
                style="width: 80%;" value="" oninput="validatePasswords()"
